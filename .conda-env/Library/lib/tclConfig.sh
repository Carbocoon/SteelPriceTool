...
# installed.
TCL_PREFIX='D:/temp_documents/公司/SteelPriceTool/.conda-env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/temp_documents/公司/SteelPriceTool/.conda-env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/temp_documents/公司/SteelPriceTool/.conda-env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/temp_documents/公司/SteelPriceTool/.conda-env\Library\include'
...
TCL_PACKAGE_PATH='D:/temp_documents/公司/SteelPriceTool/.conda-env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/temp_documents/公司/SteelPriceTool/.conda-env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/temp_documents/公司/SteelPriceTool/.conda-env\Library\lib\tclstub86.lib'
